...
public class OrderRequest {
	...
	public String toString() {
		return "OrderRequest [firstName=" + firstName + ", lastName=" + lastName + ", email=" + email + ", mobileNo="
				...
				+ ", paymentType=" + paymentType + ", getFirstName()=" + getFirstName() + ", getLastName()="
				+ getLastName() + ", getEmail()=" + getEmail() + ", getMobileNo()=" + getMobileNo() + ", getAddress()="
				+ getAddress() + ", getCity()=" + getCity() + ", getState()=" + getState() + ", getPincode()="
				+ getPincode() + ", getPaymentType()=" + getPaymentType() + ", getClass()=" + getClass()
